...
function activateEntityAt (entity, cb, xcord, ycord, zcord, mouseparam) {
   //Hope this works! x/y/z-param represent the coordinates and mouseparam the "Mouse:"-propertie. (Example: 0 or 2)
   bot.lookAt(entity.position.offset(0, 1, 0), false, () => { 
     bot._client.write('use_entity', {
       target: entity.id, 
       mouse: mouseparam,
